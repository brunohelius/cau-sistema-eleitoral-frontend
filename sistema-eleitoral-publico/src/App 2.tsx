    ...
    <ThemeProvider theme={theme}>
      ...
      <Routes>
        <Route element={<PublicLayout />}>
          ...
          <Route path="/denuncias/nova" element={<DenunciasPage />} />
          <Route path="/denuncias/:id" element={<DenunciaDetailPage />} />
          <Route path="/impugnacoes" element={<ImpugnacoesPage />} />
          <Route path="/impugnacoes/cadastro" element={<CadastroImpugnacaoPage />} />
          ...
          <Route path="/substituicoes/cadastro" element={<CadastroSubstituicaoPage />} />
          <Route path="/substituicoes/:id" element={<SubstituicaoDetailPage />} />
          <Route path="/comissao-eleitoral" element={<ComissaoEleitoralPage />} />
        </Route>
      </Routes>
    </ThemeProvider>
  )
